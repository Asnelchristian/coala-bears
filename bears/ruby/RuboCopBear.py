...
class RuboCopBear:
    ...
    def generate_config(filename, file,
        ...
        :param align_parameters:
            ...
            The `with_first_parameter` style aligns the following lines along
            the same column as the first parameter.

            The `with_fixed_indentation` style aligns the following lines
            with one level of indentation relative to the start of the line
        ...
        :param class_length_count_comments:
            Count comments while calculating class length?
        :param max_module_length:
            Max lines in a module.
        :param module_length_count_comments:
            Count comments while calculating module length?
